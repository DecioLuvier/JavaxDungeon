...
public class Level_10 extends BoardLevel {
    public Level_10(Manager manager) {
        super(manager);
    }
    ...
    public void onEnter() {
        ...
        spawn(new Wall(this, 0, 0));
        spawn(new Wall(this, 0, 1));
        spawn(new Wall(this, 0, 2));
        spawn(new Wall(this, 0, 3));
        spawn(new Wall(this, 1, 0));
        spawn(new Wall(this, 1, 3));
        spawn(new Wall(this, 2, 0));
        spawn(new Box(this, 2, 2));
        spawn(new Wall(this, 2, 3));
        spawn(new Wall(this, 2, 4));
        spawn(new Wall(this, 2, 5));
        spawn(new Wall(this, 2, 6));
        spawn(new Wall(this, 2, 7));
        spawn(new Wall(this, 3, 0));
        spawn(new Wall(this, 3, 7));
        spawn(new Wall(this, 4, 0));
        spawn(new Button(this, 4, 1));
        spawn(new Box(this, 4, 2));
        spawn(new Button(this, 4, 3));
        spawn(new Box(this, 4, 4));
        spawn(new Button(this, 4, 5));
        spawn(new Wall(this, 4, 7));
        spawn(new Wall(this, 5, 0));
        spawn(new Wall(this, 5, 3));
        spawn(new Player(this, 5, 5));
        spawn(new Wall(this, 5, 7));
        spawn(new Wall(this, 6, 0));
        spawn(new Wall(this, 6, 1));
        spawn(new Wall(this, 6, 2));
        spawn(new Wall(this, 6, 3));
        spawn(new Wall(this, 6, 4));
        spawn(new Wall(this, 6, 5));
        spawn(new Wall(this, 6, 6));
        spawn(new Wall(this, 6, 7));
        spawn(new Floor(this, 0, 0));
        ...
        spawn(new Floor(this, 2, 7));
        spawn(new Floor(this, 3, 7));
        spawn(new Floor(this, 4, 7));
        spawn(new Floor(this, 5, 7));
        spawn(new Floor(this, 6, 7));
    }

    @Override
    public void onAllBoxesOnTarget() {
        getManager().setCurrentLevel(new Level_01(getManager()));
    }
}