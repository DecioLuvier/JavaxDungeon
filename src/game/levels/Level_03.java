...
public class Level_03 extends BoardLevel {
    public Level_03(Manager manager) {
        super(manager);
    }
    ...
    public void onAllBoxesOnTarget() {
        getManager().setCurrentLevel(new Level_04(getManager()));
    }
}