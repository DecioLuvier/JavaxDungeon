...
public class Level_04 extends BoardLevel {
    public Level_04(Manager manager) {
        super(manager);
    }
    ...
    public void onEnter() {
        ...
        spawn(new Box(this, 3, 4));
        spawn(new Wall(this, 3, 6));
        spawn(new Wall(this, 4, 0));
        spawn(new Player(this, 4, 1));
    ...
    public void onAllBoxesOnTarget() {
        getManager().setCurrentLevel(new Level_05(getManager()));
    }
}