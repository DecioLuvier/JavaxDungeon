...
public class Level_07 extends BoardLevel {
    public Level_07(Manager manager) {
        super(manager);
    }
    ...
    public void onAllBoxesOnTarget() {
        getManager().setCurrentLevel(new Level_08(getManager()));
    }
}