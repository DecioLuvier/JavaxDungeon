...
public class Level_08 extends BoardLevel {
    public Level_08(Manager manager) {
        super(manager);
    }
    ...
    public void onEnter() {
        ...
        spawn(new Wall(this, 0, 7));
        spawn(new Wall(this, 1, 1));
        spawn(new Button(this, 1, 4));
        spawn(new Wall(this, 1, 7));
        spawn(new Wall(this, 2, 1));
        spawn(new Wall(this, 2, 3));
        spawn(new Button(this, 2, 4));
        spawn(new Wall(this, 2, 7));
        spawn(new Wall(this, 3, 0));
        spawn(new Wall(this, 3, 1));
        spawn(new Box(this, 3, 2));
        spawn(new Wall(this, 3, 3));
        spawn(new Wall(this, 3, 4));
        ...
        spawn(new Floor(this, 0, 7));
        spawn(new Floor(this, 1, 7));
    ...
    public void onAllBoxesOnTarget() {
        getManager().setCurrentLevel(new Level_09(getManager()));
    }
}